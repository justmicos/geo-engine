 ...
 *
 * v2.1 — 新增 AI Gateway、Evolution、Fine-Tuning 配置项。
 *
...
return [
    ...
    | v2.1: AI Gateway 配置
    |--------------------------------------------------------------------------
    | 启用后 GEOFlow 将 AI 请求全部路由到 AI Gateway (:19090)，
    | Gateway 根据 model 前缀自动选择 Provider。
    */
    'ai_gateway_enabled' => filter_var(env('AI_GATEWAY_ENABLED', false), FILTER_VALIDATE_BOOLEAN),
    'ai_gateway_url' => rtrim((string) env('AI_GATEWAY_URL', 'http://ai-gateway:19090'), '/'),
    ...
    |--------------------------------------------------------------------------
    */
    'evolution_enabled' => filter_var(env('EVOLUTION_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
    'evolution_interval_hours' => max(1, (int) env('EVOLUTION_INTERVAL_HOURS', 24)),
    'evolution_model' => env('EVOLUTION_MODEL', 'deepseek-chat'),
    'evolution_max_chunks_per_run' => max(10, (int) env('EVOLUTION_MAX_CHUNKS_PER_RUN', 50)),
    'evolution_similarity_threshold' => (float) env('EVOLUTION_SIMILARITY_THRESHOLD', 0.85),
    'evolution_auto_prune' => filter_var(env('EVOLUTION_AUTO_PRUNE', true), FILTER_VALIDATE_BOOLEAN),
    'evolution_auto_merge' => filter_var(env('EVOLUTION_AUTO_MERGE', true), FILTER_VALIDATE_BOOLEAN),
    'evolution_auto_summarize' => filter_var(env('EVOLUTION_AUTO_SUMMARIZE', true), FILTER_VALIDATE_BOOLEAN),
    'evolution_auto_link' => filter_var(env('EVOLUTION_AUTO_LINK', true), FILTER_VALIDATE_BOOLEAN),
    'evolution_auto_archive_days' => max(1, (int) env('EVOLUTION_AUTO_ARCHIVE_DAYS', 90)),
    ...
    |--------------------------------------------------------------------------
    */
    'fine_tune_enabled' => filter_var(env('FINE_TUNE_ENABLED', false), FILTER_VALIDATE_BOOLEAN),
    'fine_tune_base_model' => env('FINE_TUNE_BASE_MODEL', 'Qwen/Qwen2.5-7B-Instruct'),
    'fine_tune_method' => env('FINE_TUNE_METHOD', 'lora'),
    'fine_tune_dataset_source' => env('FINE_TUNE_DATASET_SOURCE', 'knowledge_base'),
    'fine_tune_dataset_max_samples' => max(1, (int) env('FINE_TUNE_DATASET_MAX_SAMPLES', 1000)),
    'fine_tune_dataset_min_score' => (float) env('FINE_TUNE_DATASET_MIN_SCORE', 0.7),
